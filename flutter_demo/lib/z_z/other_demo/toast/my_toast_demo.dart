  ...
  Widget build(BuildContext context) {
    return OKToast(
      ...
      child: new MaterialApp(
        ...
        home: new MyToastDemo(),
      ),
    );
  }
}

class MyToastDemo extends StatefulWidget {
  MyToastDemo({Key key}) : super(key: key);

  @override
  _MyHomePageState createState() => new _MyHomePageState();
}

class _MyHomePageState extends State<MyToastDemo> {
  int _counter = 0;
                  ...
                  child: RaisedButton(
                    onPressed: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (ctx) => MyToastDemo()));
                    },
                  ),
                ),
                Padding(
