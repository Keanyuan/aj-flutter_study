...
String selectedUrl = 'http://localhost:8080';

class ChartsWebPage extends StatefulWidget{
  final String urlStr;
  ChartsWebPage({this.urlStr});
  @override
  State<StatefulWidget> createState() {
    return _ChartsWebPageState();
  }

}

class _ChartsWebPageState extends State<ChartsWebPage> {
